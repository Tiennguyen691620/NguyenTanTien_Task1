...
import {ConfirmValidParentMatcher, errorMessages, HttpServerService} from '../Services/http-server.service';
...
export class EditStudentComponent implements OnInit {
  ...
  // tslint:disable-next-line:typedef
  private validateControlsValue(firstControlName: string, secondControlName: string) {
